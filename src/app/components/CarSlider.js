...
const cars = [
    {
        ...
        price: 29,
        stars: 3.5,
        iamge: 'images/carSlider/car01.svg',
        info: [
            {
    ...
    },
    {
        ...
        price: 25,
        stars: 5,
        iamge: 'images/carSlider/car02.svg',
        info: [
            {
                icon: "icons/carSlider/gearshift.svg",
                text: 'Manual'
    ...
    },
    {
        ...
        price: 35,
        stars: 4.5,
        iamge: 'images/carSlider/car03.svg',
        info: [
            {
                icon: "icons/carSlider/gearshift.svg",
                text: 'Automatic'
                ...
                {cars.map((car, index) => {
                    return <SwiperSlide key={index}>
                        <div className="max-w-[385px] mx-auto sm:mx-0">
                            <Image src={car.iamge} width={380} height={284} alt='' />
                            ...
                            <button className='btn btn-accent btn-lg'>See <details></details></button>
                        </div>
                    </SwiperSlide>
                })}
            </Swiper>
