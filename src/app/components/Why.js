        ...
        <section className="section flex items-center " id="why">
            <div className="container mx-auto">
                ...
                <motion.p
                    ...
                    Out dedication to provideing exceptional services sets us apart from the compoetition. Form the moment you engage with us, we strive to exced your expectations in every interaction.
                </motion.p>
                <motion.div
                ...
                <motion.div
                    ...
                    <div className="flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0">
                        ...
                        <p className="hidden xl:flex">We prioritizy your need and we go above and beyond to ensure your experience with us is nothing  short of outstanding</p>
                    </div>
                    <div className="flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0">
                        <MdTrendingUp className="text-[38px] text-accent mb-4" />
                        <h3 className="h3">Moden$ well maintained vehicles</h3>
                        <p className="hidden xl:flex">We prioritizy your need and we go above and beyond to ensure your experience with us is nothing  short of outstanding</p>
                    </div>
                    <div className="flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0">
